...
void Stage::Initialize()
{
    ...
    hBunny_ = Model::Load("Assets\\Dunuts.fbx");
    hRing_ = Model::Load("Assets\\NonDonuts.fbx");
    hPhong_Dounuts_ = Model::Load("Assets\\phon_Donuts.fbx");
...
void Stage::Update()
{
    ...
    //コンスタントバッファーの設定とシェーダーへのコンスタントバッファーのセットを書く！！
...
void Stage::Draw()
{
    ...
    Transform Ring;
    Ring.scale_ = { 0.18,0.18,0.18 };
    Ring.position_ = { -0.5,0.5,0 };
    Ring.rotate_.y += 0.3;
    Model::SetTransform(hBunny_, Ring);
    Model::Draw(hBunny_);
    ...
    Ring.scale_ = { 0.18,0.18,0.18 };
    Ring.position_ = { 0.5,1.0,0 };
    Ring.rotate_.y += 0.3;
    Model::SetTransform(hPhong_Dounuts_, Ring);
    Model::Draw(hPhong_Dounuts_);
